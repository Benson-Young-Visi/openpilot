...
private:
  ...
  QSet<QString> customOnroadUIKeys = {"AccelerationPath", "AdjacentPath", "BlindSpotPath", "Compass", "ConfidenceBall", "OnroadDistanceButton", "PedalsOnUI", "RotatingWheel", "TorqueBar"};
