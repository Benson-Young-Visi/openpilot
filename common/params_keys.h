...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DisengageVolume", {PERSISTENT, INT, "0", "101", 2, SETTINGS_SIMPLE}},
    ...
    {"EngageVolume", {PERSISTENT, INT, "0", "101", 2, SETTINGS_SIMPLE}},
    ...
    {"OnroadDistanceButton", {PERSISTENT, BOOL, "1", "0", 0, SETTINGS_SIMPLE}},
    ...
    {"StockConfidenceBallWidget", {PERSISTENT, BOOL, "1", "0", 0, SETTINGS_SIMPLE}},
