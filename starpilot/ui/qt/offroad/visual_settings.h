...
private:
  ...
  QSet<QString> customOnroadUIKeys = {"AccelerationPath", "AdjacentPath", "BlindSpotPath", "Compass", "EnableTorqueBarWidget", "OnroadDistanceButton", "PedalsOnUI", "RotatingWheel", "StockConfidenceBallWidget"};
